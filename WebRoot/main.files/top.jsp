...
style="BACKGROUND-IMAGE: url(../images/bg_nav.gif); BACKGROUND-REPEAT: repeat-x; HEIGHT: 30px">
      ...
      id=lblBra>&nbsp;</SPAN> <SPAN id=lblDep>&nbsp;</SPAN> ${sessionScope.manager.realname }  光临 </DIV>
            </TD>
      ...
      src="Top.files/nav_changePassword.gif" align=absMiddle border=0>重新登录</A> <A href="${pageContext.request.contextPath}/manager!pwdModify.action" 
